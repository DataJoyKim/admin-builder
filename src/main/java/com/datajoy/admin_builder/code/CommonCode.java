...
@AllArgsConstructor
@Builder
@Table(uniqueConstraints = {@UniqueConstraint(name="COMMON_CODE_UQ",columnNames={"codeKind", "code"})})
@Entity
public class CommonCode {
    ...
    public void update(String code, String name, CommonCodeKind codeKind) {
        this.code = code;
        this.name = name;
