class RenderBuilder {
    ...
    render(id, data) {
        ...
        const layoutEl = layout.createComponent({id:'layout'}, this.componentFactory.getInstanceMap());
    ...
    component(viewData) {
        ...
        for (let data of viewData) {
            ...
            const componentEl = comp.createComponent(data, this.componentFactory.getInstanceMap());
